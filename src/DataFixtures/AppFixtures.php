...
class AppFixtures extends Fixture
{
    ...
    {
        $serviceStorage = $manager->getRepository(ServiceCategory::class);

        foreach ($this->getServicesData() as [$name, $price, $description, $serviceName]) {

            $category = $serviceStorage->findOneBy(['name' => $serviceName]);
            $service = new Service();
